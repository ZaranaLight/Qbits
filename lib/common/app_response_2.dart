...
//
List<AppResponse2> appResponse2ModelFromJson(String str) =>
    List<AppResponse2>.from(
      json.decode(str).map((x) => AppResponse2.fromJson(x)),
    );

String appResponse2ModelToJson(List<AppResponse2> data) =>
...
String appResponse2ToJson<T, L>(
  ...
  data.toJson(dataConverter: dataConverter, listConverter: listConverter),
);
...
class AppResponse2<T, L> {
  ...
  AppResponse2({this.count, this.code, this.data, this.msg, this.list});
  ...
  factory AppResponse2.fromJson(
    ...
    data:
        json["data"] is T
            ...
            : null,
    list:
        json["list"] is List && listConverter != null
            ? List<L>.from(json["list"].map((x) => listConverter(x)))
            : null,
  );
